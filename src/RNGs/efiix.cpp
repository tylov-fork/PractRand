...
void PractRand::RNGs::Polymorphic::efiix8x384::seed(vRNG *seeder_rng) { implementation.seed(seeder_rng); }
...
void PractRand::RNGs::Polymorphic::efiix16x384::seed(vRNG *seeder_rng) { implementation.seed(seeder_rng); }
...
void PractRand::RNGs::Polymorphic::efiix32x384::seed(vRNG *seeder_rng) { implementation.seed(seeder_rng); }
...
void PractRand::RNGs::Polymorphic::efiix64x384::seed(vRNG *seeder_rng) { implementation.seed(seeder_rng); }
...
void PractRand::RNGs::Raw::efiix8x384::seed(PractRand::RNGs::vRNG *source_rng) {
	a = source_rng->raw8();
	b = source_rng->raw8();
	c = source_rng->raw8();
	i = source_rng->raw8();
...
void PractRand::RNGs::Raw::efiix16x384::seed(PractRand::RNGs::vRNG *source_rng) {
	a = source_rng->raw16();
	b = source_rng->raw16();
	c = source_rng->raw16();
	i = source_rng->raw16();
...
void PractRand::RNGs::Raw::efiix64x384::seed(PractRand::RNGs::vRNG *source_rng) {
	a = source_rng->raw32();
	b = source_rng->raw32();
	c = source_rng->raw32();
	i = source_rng->raw32();
