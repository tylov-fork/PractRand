	...
	namespace RNGs {
		namespace Polymorphic {
			namespace NotRecommended {
				...
				Uint64 Transform32::get_flags() const {return base_rng->get_flags();}
				Transform32::~Transform32() {delete base_rng;}
				void Transform16::seed(Uint64 s) {base_rng->seed(s);}
				Uint64 Transform16::get_flags() const {return base_rng->get_flags();}
				Transform16::~Transform16() {delete base_rng;}
				void Transform8::seed(Uint64 s) {base_rng->seed(s);}
				Uint64 Transform8::get_flags() const {return base_rng->get_flags();}
